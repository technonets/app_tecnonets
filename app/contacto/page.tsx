...
function ContactForm() {
  ...
  if (isSent) {
    return (
      <div className="text-center py-12 animate-in fade-in zoom-in duration-500">
        ...
        <p className="text-gray-400">Gracias por contactarnos. Te responderemos lo antes posible por email o WhatsApp.</p>
  ...
  const inputClasses = (field: string) => `
    w-full bg-white/5 border rounded-lg px-4 py-3 text-white focus:outline-none transition-all duration-300
    ${errors[field] 
    ...
    <form className="space-y-6" onSubmit={handleSubmit} noValidate>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          <label htmlFor="name" className="text-sm font-medium text-gray-300">Nombre <span className="text-red-400">*</span></label>
          <input 
            type="text" 
            id="name" 
            value={formData.name}
        ...
        <div className="space-y-2 relative">
          <label htmlFor="country" className="text-sm font-medium text-gray-300">País <span className="text-red-400">*</span></label>
          ...
          {showCountryDropdown && filteredCountries.length > 0 && (
            <div className="absolute z-50 w-full mt-1 bg-gray-900 border border-white/20 rounded-lg shadow-2xl max-h-60 overflow-y-auto">
              {filteredCountries.slice(0, 10).map(country => (
                <button
                  key={country.name}
                  type="button"
                  onClick={() => selectCountry(country)}
                  className="w-full text-left px-4 py-3 hover:bg-primary/20 transition-colors text-white border-b border-white/5 last:border-0 flex items-center gap-3"
                >
        ...
        <div className="space-y-2 md:col-span-2">
          <label className="text-sm font-medium text-gray-300">Teléfono / WhatsApp <span className="text-red-400">*</span></label>
          <div className="flex gap-3">
            <input
              type="text"
              value={formData.countryCode}
              readOnly
              className="bg-white/5 border border-white/10 rounded-lg px-3 py-3 text-white focus:outline-none transition-all duration-300 w-[100px] cursor-not-allowed opacity-75"
      ...
      <div className="space-y-2">
        <label htmlFor="service" className="text-sm font-medium text-gray-300">Tipo de Proyecto <span className="text-red-400">*</span></label>
        <select 
          id="service" 
      ...
      <div className="space-y-2">
        <label htmlFor="message" className="text-sm font-medium text-gray-300">Mensaje <span className="text-red-400">*</span></label>
        <textarea 
          id="message" 
            ...
            <div>
              ...
              <div className="space-y-6">
                 ...
                 <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-white mb-1">Redes Sociales</h3>
                    <p className="text-gray-400">@tecnonets en YouTube, Instagram</p>
                  </div>
                </div>
              </div>
            </div>
